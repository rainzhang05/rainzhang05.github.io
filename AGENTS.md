...
- A mark may also declare `scale`, an optical adjustment against that shared height for when equal ink still does not read as equal weight — MNT's compact square carries `1.12` so it sits level with the FEITIAN wordmark beside it.
