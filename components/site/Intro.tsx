  ...
  return (
    <section className="flex flex-wrap items-start justify-between gap-x-gutter gap-y-8 pb-20 pt-hero">
      <div className="min-w-0 max-w-[62ch] flex-1 basis-[480px]">
        ...
        <h1 className="mt-5 max-w-[21ch] text-hero font-normal">{copy.heading}</h1>
        <p className="mt-6 max-w-[58ch] text-body-lg text-ink-2">{copy.body}</p>
        <p className="mt-4 flex items-center gap-2.5 text-body-15 text-ink-2">
