...
export const ja: Copy = {
  ...
  meta: {
    ...
    description:
      'サイモンフレーザー大学でコンピュータサイエンスを学ぶ4年生。Python・TypeScript・Rust で、Web システムの設計から本番運用までを一貫して担当しています。',
    ogAlt:
  ...
  intro: {
    ...
    body: 'Rain Zhang です。サイモンフレーザー大学でコンピュータサイエンスを学ぶ4年生です。この1年は、セキュリティキーの会社と不動産管理会社で実際に運用されるシステムを、主に Python・TypeScript・Rust で開発し、運用してきました。',
    resume: '履歴書',
  ...
  featured: [
    ...
    },
    {
      ...
      sections: [
        {
          label: '概要',
          text: 'FIDO2 を使って開発する人のための Flask アプリケーションです。実機または仮想の認証器で登録・サインインし、WebAuthn のリクエストを JSON のまま編集し、返ってきたデータを読み解き、FIDO Alliance のメタデータから任意の認証器を調べられます。飛天ジャパンでのインターン中に作り、今も保守しています。',
        },
        {
          label: '仕組み',
