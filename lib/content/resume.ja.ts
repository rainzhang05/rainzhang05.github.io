...
export const resumeJa: ResumeCopy = {
  ...
  meta: {
    ...
    description:
      'バンクーバー在住のフルスタックデベロッパー・プロダクトエンジニア、Rain Zhang の履歴書。このページでそのまま読めます。PDF のダウンロードもできます。',
  },
  tagline:
    'フルスタックデベロッパー・プロダクトエンジニア · コンピュータサイエンス学士 · サイモンフレーザー大学',
  contact: [
    [{ text: 'バンクーバー、BC州、カナダ' }],
    [
  ...
  experience: [
    {
      ...
      dates: '2026年8月 – 現在',
      bullets: [
        '不動産・ストラータ管理会社で社内システムの全般を任され、要件の整理と設計からホスティング、デプロイ、保守まで一貫して担当しています。',
        'MNT Realty のプラットフォームを一から作り直し、公開ウェブサイト・居住者向けオーナーポータル・社内向け管理コンソールの3つを1つのアプリケーションにまとめました。',
        '置き換える業務を見極めた上で、散らばっていたツールを一つにまとめる「MNT Control Center」を Next.js・Node.js・PostgreSQL で設計・開発しました。',
        'Microsoft Entra ID・Graph API・OAuth 2.0 を使い、組織アカウントでのサインインと権限管理を整えました。',
        '時間を取られていた繰り返しの事務作業を自動化しました。受信メールの振り分け、所有者情報の照会、社内文書をもとに社員の質問へ答える社内アシスタントなどです。',
      ],
    },
    {
      id: 'resume-feitian',
      ...
      dates: '2025年9月 – 12月',
      bullets: [
        '耐量子計算機暗号（PQC）対応の FIDO2 に必要なものを定義し、公開用の WebAuthn 開発者向けプラットフォーム、Rust によるソフトウェアセキュリティキー、顧客向けデモサイトの3つを開発から運用まで担当しました。',
  ...
  projects: [
    {
      ...
      dates: '2026年8月 – 現在',
      bullets: [
        '公開ウェブサイト、居住者向けのオーナーポータル、社内向けの管理コンソールという3つの利用者向けの画面を、3つのサブドメイン・1つのビルドで提供しています。',
    ...
    },
    {
      ...
      dates: '2025年9月 – 現在',
      bullets: [
        'FIDO2 を使って開発する人のための公開ツール。適したツールがなかったため自作しました。実機または仮想の認証器で登録・サインインし、返ってきたデータを読み解き、FIDO Alliance のメタデータを調べられます。',
