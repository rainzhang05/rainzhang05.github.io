          ...
          {status === "sent" ? (
            ...
            <form onSubmit={onSubmit} className="space-y-5" noValidate>
              ...
              <button
                ...
                className="group relative inline-flex items-center gap-2 bg-gradient-to-r from-[var(--accent)] to-[var(--accent-strong)] text-white px-5 py-3 rounded-[calc(var(--r-sm)*1px)] text-sm font-medium shadow-[0_4px_14px_-4px_color-mix(in_oklab,var(--accent)_45%,transparent)] hover:shadow-[0_10px_24px_-8px_color-mix(in_oklab,var(--accent)_60%,transparent)] hover:-translate-y-[1px] active:translate-y-0 active:shadow-[0_2px_8px_-2px_color-mix(in_oklab,var(--accent)_40%,transparent)] transition-[transform,box-shadow] duration-200 ease-out disabled:opacity-50 disabled:translate-y-0 disabled:shadow-none"
              >
