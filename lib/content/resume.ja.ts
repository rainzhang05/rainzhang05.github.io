  ...
  experience: [
    {
      ...
      dates: '2026年8月 – 現在',
      bullets: [
        '不動産・ストラータ管理会社で唯一のエンジニアとして、要件の整理と設計からホスティング、デプロイ、保守まで一貫して担当しています。',
        'MNT Realty のプラットフォームの範囲を決めて一から作り直し、公開ウェブサイト、居住者向けのオーナーポータル、社内向けの管理コンソールを1つのアプリケーションで提供しています。',
